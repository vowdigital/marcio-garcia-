...
const images = [
  ...
  ['principles', path.join(doctorFolder, 'dr.jpg')],
  ['logo', path.join(doctorFolder, 'logo.png')],
  ['curtain', path.join(doctorFolder, 'cortina.png')],
  ['bg2', path.join(doctorFolder, 'bg2.png')],
